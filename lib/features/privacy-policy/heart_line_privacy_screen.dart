...
class HeartLinePrivacyScreen extends ConsumerStatefulWidget {
  const HeartLinePrivacyScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _HeartLinePrivacyScreenState();
}

class _HeartLinePrivacyScreenState
    extends ConsumerState<HeartLinePrivacyScreen> {
...
<body>
    <p style="text-align: center;"><strong>Privacy Policy for HeartLine app</strong><br><br></p>
    <p>Disclaimer: &nbsp;<span style="text-align: justify;color: rgb(0, 0, 0);font-size: 15px;">Our app (<strong>HeartLine</strong>)&nbsp;</span><strong><span style="text-align: justify;color: rgb(0, 0, 0);font-size: 15px;border: 0px;">doesn&apos;t represent any government entity</span></strong><span style="text-align: justify;color: rgb(0, 0, 0);font-size: 15px;">&nbsp;and all the content is created by teachers of HeartLine.</span><br><br><b><span style="text-align: justify;color: rgb(0, 0, 0);font-size: 15px;">Flash Coders</span></b> built the HeartLine app as a Commercial app. This SERVICE is provided by <b style='color: rgb(0, 0, 0); font-family: "Helvetica Neue", Helvetica, Arial, sans-serif; font-size: medium; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;'><span style="text-align: justify; color: rgb(0, 0, 0); font-size: 15px;">Flash Coders</span></b> and is intended for use as is.</p>
    <p>This page is used to inform visitors regarding my policies with the collection, use, and disclosure of Personal Information if anyone decided to use my Service.</p>
    <p>If you choose to use my Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that I collect is used for providing and improving the Service. I will not use or share your information with anyone except as described in this Privacy Policy.</p>
    <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at HeartLine unless otherwise defined in this Privacy Policy.</p>
