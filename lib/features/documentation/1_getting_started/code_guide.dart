...
<ol>
    ...
    <li><span style="font-family: Georgia, serif; font-size: 18px;">Please be extra careful while naming things, as it will be difficult for other developers to understand your code if name is bad. (Only Good names just like flash coders. 😎)</span><br><br><br><span style="font-size: 20px;">Note: We&apos;ll keep on updating this based on our learning so keep yourself up to date with new and best practices of flutter.&nbsp;</span><br><br><span style="font-size: 20px;">Thank you.&nbsp;</span><br><br><br></li>
</ol>
""";
