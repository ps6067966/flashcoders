                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () {
                              ...
                              showCupertinoModalPopup(
                                ...
                                builder: (context) {
                                  return CupertinoAlertDialog(
                                    title:
                                        const Text("Sign in to create a post"),
                                    actions: [
                            ...
                            context
                                .pushReplacementNamed(BlogPath.createBlogPost);
                          },
                          child: const Padding(
